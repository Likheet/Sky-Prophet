 ...
 * @returns {string} date in format "WeekDayName MonthName, Date" e.g. "Sunday 10, Jan"
 */
 ...
 * @param {number} timezone Timezone shift from UTC in seconds
 * @returns {string} time in format "Hours:Minutes AM/PM" e.g. "10:30 AM" or "10:30 PM"
 */
 ...
 * @param {number} timeUnix Unix time in seconds
 * @param {number} timezone Timezone shift from UTC in seconds
 * @returns {string} hours in format "Hours AM/PM" e.g. "10 AM" or "10 PM"
 */
